...
model_compare <- tibble(
  ...
  Predictors = c(
    formula(model_dt1)[[3]],
    formula(model_dt2)[[3]],
    formula(model_gbm1)[[3]],
    formula(model_gbm2)[[3]],
    formula(model_lm1)[[3]],
    formula(model_lm2)[[3]],
    formula(model_lm3)[[3]],
    formula(model_lm4)[[3]],
...
```
The best model is model is `r model_compare$ModelName[1]`, a `r model_compare$ModelType[1]` model using the formula price vs `r formula(model_compare$ModelName[1])[[3]]`. It has an RMSE of `r model_compare$RMSE[1]`, a MAE of `r model_compare$MAE[1]`, and an adjusted R square of `r model_compare$AdjRSquare[1]`.
